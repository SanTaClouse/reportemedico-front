/**
 * Logos de marca oficiales (paths de Simple Icons, simpleicons.org — CC0).
 * Se renderizan con fill="currentColor", así heredan el color del contenedor
 * (en los botones de compartir, blanco). viewBox 24×24.
 */
