...
export default function MedicalArticlesBanner({
  priority = false,
  heading = 'Tu conocimiento merece ser leído por toda la República Dominicana',
}: Props) {
  return (
    <div className="relative rounded-2xl overflow-hidden bg-[var(--brand-navy)] h-[340px] md:h-[360px]">
      <ParallaxImage
        src="https://res.cloudinary.com/dfppghbdf/image/upload/v1773771085/Reporte-Medico/Media/20260317_medicos-creando-articulo.png"
